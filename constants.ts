...
export const ONBOARDING_STEPS_CONFIG = [
  ...
  { id: 'experience_mapping', title: 'Mapea tu Experiencia', description: 'Cuéntanos sobre tu formación y experiencia. Esto formará el tronco que conecta tus pasiones con tus proyectos.' },
